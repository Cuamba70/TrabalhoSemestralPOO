...
/**
 * Classe que contem as salas reservadas.
 * @author 
 * @version 1.0
 */
@Entity(name = "reservarsala")
public class ReservarSala implements Serializable{
   ...
   @GeneratedValue
    ...
    public ReservarSala(Salas salas, Funcionario nomefuncionario, Docente docentes, Date data, String estado) {
        this.salas = salas;
