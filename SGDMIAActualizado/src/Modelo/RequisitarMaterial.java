...
/**
 * Classe que contem os materias requisitados.
 * @author 
 * @version 1.0
 */
...
public class RequisitarMaterial {
     ...
     * @param estado 
     */
    public RequisitarMaterial(int codigo, Estudante nomeestudante, Funcionario nomefuncionario, String materialrequisitado, Date data, String estado) {
        this.codigo = codigo;
